...
<div class="jumbotron">
    ...
    out.println("Welcome " + cust_name + " to the implict object page" + "<br>" );
    %>
    <% String servletName = config.getServletName();
        out.println("Servlet Name is " +servletName + "<br>");%>
    <% pageContext.setAttribute("guest","Dmitry",pageContext.PAGE_SCOPE);
    String name = (String)pageContext.getAttribute("guest");
    out.println("Welcome guest " +name + "<br>");%>
